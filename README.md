...
- [xx] Sign up for GitHub
- [xx] Fork a repo into your GitHub
- [xx] Install Git
- [xx] Configure Git
- [xx] Install Python 3
- [xx] Install VS Code 
- [xx] Clone your new GitHub repository/repo down to your machine
- [xx] Explore your local repo in VS Code
- [xx] Execute Python scripts
- [xx] Edit Python scripts
- [xx] Commit changes (with a message!) and push/sync back up to GitHub for sharing
